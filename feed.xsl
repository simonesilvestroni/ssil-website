    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        <header>
          ...
          <div class="head">
            <div class="avatar">
              <img src="/assets/images/simonesilvestroni-avatar-uphoto.png" alt="Avatar of Simone Silvestroni"/>
            </div>
        ...
        <main>
          ...
          <p class="about"><a href="https://simonesilvestroni.com/about/">About Simone Silvestroni →</a></p>
        </main>
      </body>
    </html>
  </xsl:template>
